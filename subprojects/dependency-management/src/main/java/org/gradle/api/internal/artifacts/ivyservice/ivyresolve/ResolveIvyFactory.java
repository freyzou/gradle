    ...
    public ComponentResolvers create(ResolutionStrategyInternal resolutionStrategy,
        ...
        for (ResolutionAwareRepository repository : repositories) {
            ...
            if (baseRepository.isLocal()) {
                moduleComponentRepository = new CachingModuleComponentRepository(moduleComponentRepository, cacheProvider.getInMemoryOnlyCaches(attributesSchema),
                ...
                moduleComponentRepository = new CachingModuleComponentRepository(moduleComponentRepository, cacheProvider.getCaches(attributesSchema),
                    cachePolicy, timeProvider, componentMetadataProcessor);
            }
